...
export default function Contact() {
  ...
  return (
    <section id="contact" aria-labelledby="contact-heading" className="py-16 md:py-20">
      <Container>
        <div className="border-border bg-surface shadow-card relative rounded-[20px] border px-6 py-12 text-center sm:px-8">
          <Collectible id="contact" className="absolute top-3 right-3" />
          <h2
            id="contact-heading"
